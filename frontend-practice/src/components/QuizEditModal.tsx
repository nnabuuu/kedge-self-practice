...
import OrderIndependentGroupsEditor from './OrderIndependentGroupsEditor';
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          {editingQuiz.type === 'fill-in-the-blank' && (
            <div>
              ...
              <OrderIndependentGroupsEditor
                groups={getOrderIndependentGroups()}
                blanksCount={(editingQuiz.question?.match(/____/g) || []).length}
                onAddGroup={handleAddOrderIndependentGroup}
                onRemoveGroup={handleRemoveOrderIndependentGroup}
                onToggleBlankInGroup={handleToggleBlankInGroup}
              />
            </div>
          )}
