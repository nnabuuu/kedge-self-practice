...
| 题目ID | 题目预览 | 图片占位符 | 状态 |
|--------|----------|------------|------|
| `1a1ebb30-...` | 右图所示是民国九年的一则报纸广告... | `{{image:51d16c6c-...}}` | 缺失 |
| `40248d75-...` | "宇宙之间，一理而已..."。提出该思想...是 | `{{image:word/media/image16.wmf}}` | 缺失 |
| `7f572049-...` | 16世纪，马丁·路德领导的宗教改革... | `{{image:temp_xcrvdl8e9fn}}` | 缺失 |
| `aa203b98-...` | 14世纪与17世纪，欧洲先后出现了两场... | `{{image:0ae399b0-...}}` | 缺失 |
| `bf0a23d9-...` | 下图为《15世纪欧洲出现印书坊的城市》... | `{{image:temp_qpmm26xa28b}}` | 缺失 |
